...
const PROGRAM = {
  push: {
    title: "Poussée I",
    exos: [
      ["Développé couché (barre ou haltères)", "4", "8-10"],
      ["Développé militaire haltères", "3", "8-10"],
      ["Écarté couché ou pec deck", "3", "12-15"],
  ...
  push2: {
    ...
    exos: [
      ...
      ["Dips (lestés si possible)", "3", "8-12"],
      ["Élévations latérales + frontales", "3", "12-15"],
      ["Développé Arnold", "3", "10-12"],
      ["Extensions triceps nuque", "3", "12-15"],
    ]
  },
  pull: {
    title: "Tirage I",
    exos: [
      ...
      ["Rowing barre ou haltère", "4", "8-10"],
      ["Tirage horizontal poulie basse", "3", "10-12"],
      ["Face pull", "3", "12-15"],
      ["Curl biceps barre EZ", "3", "10-12"],
    ]
  },
  pull2: {
    title: "Tirage II",
    exos: [
      ["Rowing unilatéral haltère", "4", "8-10"],
      ["Tirage vertical prise large", "3", "10-12"],
      ["Pull-over haltère", "3", "12-15"],
      ["Curl marteau", "3", "10-12"],
      ["Shrugs trapèzes", "3", "12-15"],
    ]
  },
  legs: {
    title: "Jambes",
    exos: [
      ["Squat (barre ou gobelet)", "4", "8-10"],
      ["Soulevé de terre roumain", "3", "8-10"],
      ["Fentes marchées", "3", "10-12"],
      ["Leg curl ou pont fessier", "3", "12-15"],
  ...
  cardio: {
    title: "Cardio & Abdos",
    exos: [
      ["Marche rapide, vélo ou rameur (30-40 min)", "1", "30-40 min"],
      ["Crunch classique", "3", "15-20"],
      ["Relevé de jambes suspendu ou au sol", "3", "12-15"],
      ["Gainage planche + variantes", "3", "40s"],
  ...
  mobility: {
    ...
    exos: [
      ["Marche légère (20-30 min)", "1", "20-30 min"],
      ["Étirements complets", "1", "10-15 min"],
      ["Mobilité hanches / épaules", "1", "10 min"],
      ["Respiration / relâchement", "1", "5 min"],
    ]
  }
};
...
function buildExerciseInputs(containerId, categoryKey){
  ...
  container.innerHTML = program.exos.map(([name, sets, reps]) => {
